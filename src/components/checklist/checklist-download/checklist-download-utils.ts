import { MDX_DIV_CUSTOM_CHECKLIST_BODY_CLASS_NAME } from "@/components/mdx/mdx-div/mdx-div-custom/mdx-div-custom-checklist/mdx-div-custom-checklist-client.const";
...
function generateChecklistMd(checklistMeta: ChecklistMeta) {
  const textLines = [];
  ...
  for (const checklistNode of Array.from(checklistBodyEl.childNodes)) {
