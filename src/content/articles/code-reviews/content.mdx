...
There are some other systems for prefixing review comments. David Garcia has a [two-part tagging system](https://blog.techdocs.studio/p/a-tagging-system-for-documentation-review-comments) comprising severity ("blocker", "improvement", "optional") and category ("clarity", "bug", "organization", "style", "consistency").
...
Part of being a good team mate is to maximise others' developer experience and this is certainly applicable to code reviews.

I think it's best to balance commendation with criticism. This helps build a positive relationship with contributors and have more influence.

> Pull-quote: “When someone asks you to review a document or pull request or conference talk, do call out the sections that you think are great, but pay them the respect of being (kindly!) honest about their work. Giving constructive and critical feedback isn’t easy. It takes effort to tease out exactly what isn’t working and find the words to explain why it’s not as good as it can be. It’s a more difficult conversation. But you won’t help your colleague if you hide the truth.”
>
> – Tanya REILLY • [_The Staff Engineer's Path_](/reading/the-staff-engineers-path) • Chapter 8. Good Influence at Scale, pp. 367

Also I try to minimise iterations. Ideally all relevant feedback should be collected together and delivered in one go, rather than sprinkling small pieces of feedback over many hours and forcing the contributor to repetitively go back and make changes. When reviewing a significant sized pull request, I try to keep a list of my comments in a local Markdown file and then post them all at once when I'm done. GitHub's [Pull request reviews](https://docs.github.com/en/pull-requests/reference/pull-request-reviews) feature helps with this.


## Ownership

If you want to act as a steward of the code base, often referred to as "ownership", you will want to take responsibility for changes you approve and suggestions you make. Your feedback will need to be consistent over time and not self-contradictory. Mistakes in feedback are understandable, but should be acknowledged and corrected going forward. I find [code review checklists](/checklists?checklist-meta.checklistTags-tag=software-development) a great tool for maintaining awareness and consistency in feedback and self-correcting biases.

If you approve a pull request without any feedback, it can be good to leave a brief comment, just to let the contributor know that you did your due diligence. It can be a simple one sentence, high level summary of what checks you made.


## Additional ideas and thoughts

Sometimes I automate parts of this process with AI, depending on the situation. I try to avoid overly relying on AI, as I think it's important to maintain direct knowledge of the code base.

Obviously there isn't always enough time to follow these processes religiously. If it's a high-impact change, e.g. significant production changes, I'll try to ask for more time to review it and provide regular progress updates in a chat thread, just like a larger development task. If additional time is not granted, I'll still make a "best effort", demonstrated by comments, feedback where necessary, testing, etc. At least I can show that I tried.

Sometimes a big, scary change-set isn't actually such a heavy burden as it initially appears. If much of the change-set can be mentally reduced to a common pattern, then I can describe the pattern in a brief written sentence (or read and understand the developer's description in the PR notes), check and ensure it is appropriate to the situation, ensure it's being applied consistently and correctly and ensure it's not being applied where it shouldn't. This might not require reading every individual line of code.

The book [_Software Engineering at Google_](/reading/software-engineering-at-google) has some useful guidance under the section "Types of Code Reviews". They categorise code reviews into four types, each with a preferred treatment:
...
Categorising a code review, similar to above, one can focus effort and skip unnecessary processes.
...
- [Book: Software Engineering at Google • Titus WINTERS, Tom MANSHRECK, Hyrum WRIGHT](https://www.kobo.com/au/en/ebook/software-engineering-at-google)
- [Book: The Staff Engineer's Path • Tanya REILLY](/reading/the-staff-engineers-path)

Related resources you might find helpful:

- [Blog: A tagging system for documentation review comments • David GARCIA](https://blog.techdocs.studio/p/a-tagging-system-for-documentation-review-comments)
- [Post: The Code Review Pyramid • Gunnar MORLING](https://www.linkedin.com/feed/update/urn:li:activity:7083099045279232000)
- [Video: How to Do Code Reviews Like a Human • Michael LYNCH](https://www.youtube.com/watch?v=0t4_MfHgb_A)