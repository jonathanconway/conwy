...
In cases like these, the approach of "sub pull requests" can be useful.

***Merge small pull requests into a larger pull request, then merge that to main.***

This way we can get the best of both worlds: 

- We can break our change into smaller pieces 
- _And_ we can keep them together, for merging to the main branch atomically
