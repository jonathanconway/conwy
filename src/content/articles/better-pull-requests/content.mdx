...
For screen recordings, I prefer to avoid animated GIFs and instead use formats such as MP4, as these formats allow the viewer to manually scroll through the video. I use a compression tool, such as [HandBrake](/tools/hand-brake), to reduce the file size before uploading.
