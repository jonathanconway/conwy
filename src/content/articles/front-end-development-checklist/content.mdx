...
A solution is to only use a subset of checklist items in each situation.

My Front end development checklist groups items into heading and also filterable tags. You can quickly narrow down the list to a much more manageable size by using the tag filters.
