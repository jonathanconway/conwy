...
There is [some research](https://veganmiche.blog/2023/01/07/how-much-fat-can-you-lose-from-walking-how-to-lose-more) showing that exercise at a moderate pace (60% max heart rate) is optimal for fat burning.
...
- **Quality over quantity.** In each workout, I try to prioritise overall quality. First priority is safety – none of the movements should cause severe pain or injury. Next, I want to strain the muscles enough to feel satisfied that it was a thorough workout. This involves a kind of "good pain" or burning feeling, where you know that your muscle was tested. This doesn't necessarily have to involve training to complete failure, though I try to do that from time to time.
- **Maximising reps, minimising sets.** I try to maximise the number and/or intensity of reps and minimise the number of sets. Research shows that the number of sets is not as important as the intensity of the first set. What is important is to thoroughly exercise the muscle at least once in a session. It is less important how many _times_ within a single session a muscle is stressed. (See: [Extending an Active Life: Insights from Molecular Exercise Physiologist with Professor Keith Baar](https://www.youtube.com/watch?v=anB-UMXIDQA))
...
HIIT also gives various benefits, such as slowing ageing, improving heart health and (See: [https://www.youtube.com/watch?v=anB-UMXIDQA](https://www.youtube.com/watch?v=anB-UMXIDQA)).
...
Moderate to high intensity exercise can be used with high impact movements (such as running, squat jumping or jumping onto and off of a raised surface) to improve bone strength, preventing osteoporosis. (See: [The Best Exercise Type and Frequency for Bone Density](https://www.youtube.com/watch?v=bHS1zzlbNV4), [Best Exercises to Strengthen Your Bones (Backed by Science)](https://www.youtube.com/watch?v=HzPNUIA732Y)).

I do a brief session of HIIT 2 times per week. I also try to incorporate some high intensity periods into of my strength training sets and swimming laps.

### Swimming

I like to do laps at the local pool. Maybe pool-swimming is not 100% good on the environmental scale, so I might someday switch to ocean or lake swimming. Swimming is a great all-round cardio workout and very safe and low-impact, as well as being good for flexibility and posture. And being in the water is fun!
...
It's important to get any localised or persistent pain treated. After experiencing some upper back pain, I personally found it helpful to visit a physiotherapist for a few sessions, over which they provided training on specific exercises and postures I could practice, to treat the issue.

To be sure, there can be some unavoidable physical pain involved in regular exercise. Feeling fatigued, occasional muscle aches, the odd heel spur. Assuming full care is taken to avoid injury, workouts can just feel tough sometimes.

<a name="content--quote--judgements" />

> Pull-quote: “What upsets people is not things themselves but their judgements about the things. ... So when we are thwarted or upset or distressed, let us never blame someone else but rather ourselves, that is, our own judgements.”
>
> – EPICTETUS • [_Handbook (Encheiridion), 5_](http://classics.mit.edu/Epictetus/epicench.html)

<a name="content--quote--possible" />

> Pull-quote: “Start by doing what's necessary; then do what's possible; and suddenly you are doing the impossible.”
>
...
- **Stoicism.** The stoic philosophy tells us that our minds often make things worse than they really are. I found this helpful when applied to exercise. My mind makes up a story about how difficult 10 push-ups will be. In reality, after the first 3 or so, I'm already on a roll. Effort is often not as difficult as it seems at first.

### Muscle recovery

There doesn't seem to be any evidence that breaks significantly improve muscle recovery. For this reason, I prefer to work out daily, though I slightly vary the routine just for fun.

There is evidence that certain foods are better for muscle recovery – fruits and vegetables, specifically. (See: [Foods to Improve Athletic Performance and Recovery](https://www.youtube.com/watch?v=bfERQJLvo6A)).

### Managing injury

Injury is, unfortunately, occasionally part of life. From time to time I might trip and get bruised or pull a ligament.

Interestingly, for injured ligaments, as long as the injury is not severe, research seems to indicate that the best way to recover is to continue exercising, albeit as a reduced intensity. Professor Keith Baar suggests bearing some weight using the affected muscle group to put tension on the affected ligaments. This helps keep the cells in these ligaments active, speeding up the recovery. (See: [Extending an Active Life: Insights from Molecular Exercise Physiologist with Professor Keith Baar - Common Injuries and Health Risks](https://youtu.be/anB-UMXIDQA?si=BRBHzRn6383OQclU&t=1800).)

In my own personal experience, I always recovered within days, continuing to exercise with reduced weight, intensity and reps and gradually increasing them back to normal.
...
I like to keep a playlist of exercise tracks on my YouTube app, always ready to go as soon as I commence a work out.
...
- **Health:** Nutritious, whole food, no added sugar, high-fibre, high in anti-oxidants, low in toxins. Fruit and vegetables also have a high water content, keeping you hydrated.
- **Environment:** I minimise use of animal products. This results in a low environmental impact.
- **Organic:** Using the money saved from minimising meat consumption, I can afford to buy some organic fruit and vegetables. These can be both healthier and less impactful on the environment, due to lower use of pesticides.
- **Storage:** Most of the stuff can just be kept in a cupboard. I'll usually pick up the veggies the same day I eat them, but they keep pretty well in the fridge if I decide to do a weekly shop. Frozen veggies can, of course, be kept in the freezer indefinitely (and apparently [may be more nutritious than fresh](https://edition.cnn.com/2019/05/30/health/frozen-fruit-vegetables-drayer-food/index.html)!). An additional advantage of plant foods is that they tend to spoil less and don't produce harmful bacteria when not cooled (say, when the power goes out, the fridge fails or you just forget to put them in the fridge).
...
- [The Miraculous Healing Power of Food • Anthony LIM](https://www.youtube.com/watch?v=Nuts6ZE5wok)
- [Miche, PhD](https://www.youtube.com/@MichePhD)
- [Simon Hill](https://www.youtube.com/@TheProofWithSimonHill)
- [Physicians Committee](https://www.youtube.com/@PhysiciansCommittee)
- [NutritionFacts.org](https://www.youtube.com/@NutritionFactsOrg)
- [Talking with Docs](https://www.youtube.com/@TalkingWithDocs)
