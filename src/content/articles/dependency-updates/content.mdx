...
<LinkCta
  ...
  imageSrc="/images/illustrations/composite/dependency-updates.png"
/>

## Further reading

- [Blog: Hardening npm dependency security • Alex O'CALLAGHAN](https://alexocallaghan.com/hardening-npm-dependency-security)