...
![Price histories of all eTIBs in issuance. Source: ASX](/images/articles/etibs/etibs-price-history.png)
...
Some cash set aside for a rainy day can provide a "good enough" short-term inflation hedge, if invested at the highest possible interest rate, such as in a High Interest Savings Account (HISA) or Term Deposit. The interest on cash tends to make up for much of the inflation. (This is backed up by empirical evidence and by the Reserve Bank's deliberate measures of increasing the cash rate to mitigate inflation.)

There is a longer-term problem, however: money you save today will likely be heavily eroded by inflation 10 years from now. This is because the [Reserve Bank of Australia](https://www.rba.gov.au) (RBA) deliberately targets long-term mild inflation in order to maintain full employment (at the time of writing). Even a modest inflation rate compounds over time. So while 3% inflation might not seem like much, compounded over 10 or more years, it will reduce your $100 savings to only around $73 (100 * ((1 - 0.03) ^ 10) ≈ $73.74).

[Ben Felix, speaking on the topic of inflation protection](https://www.youtube.com/watch?v=1a3XnvRCcVo), says that diversified equities in a low-cost index fund provide the best long-term protection against inflation. This is backed up by strong theoretical and empirical evidence. 

However (and this is also backed up by strong theoretical and empirical evidence) equities are _not at all times_ a reliable inflation hedge. Stocks are volatile and can undergo periods of downturn. Worse – periods of high unexpected inflation tend to negatively impact stock prices.

So you might still want some "safe asset" to cover your expenses during periods when inflation is high and equities are down. Something that keeps up with inflation but is less volatile than stocks.
...
There is some re-investment risk, as this strategy involves future buying of eTIBs, and, over time, some of these bonds might increase in price. But if the eTIB income is combined with returns from equity investments, then over a 10-15 year period, the total amount for re-investment should match or exceed inflation, allowing you to fairly reliably maintain 5-15 years of safe inflation protection.
