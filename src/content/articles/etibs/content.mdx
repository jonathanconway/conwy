...
However, **equities do not always and reliably hedge inflation**. Stocks are volatile and can undergo periods of downturn. Worse, periods of high unexpected inflation and low GDP growth have seen negative real stock returns.
...
Ultimately I think it would be better if the Finance / Fintech industry developed a more user-friendly solution. In my Ideas section, I proposed an [Inflation-linked savings account](/ideas/inflation-linked-savings-account). Maybe I'll try to build a product like this myself one day.
