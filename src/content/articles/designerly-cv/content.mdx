...
Just to be sure, when building the intial blocks (before filling them in with content) I did regularly export to Word and PDF and check the results.
...
A quirk of word processors like LibreOffice, when exporting an editable format like Word/DOCX, is that you cannot rely on the end-user having all the fonts you use.
...
In the spirit of Christmas I thought I'd share a template based on my CV. Feel free to re-use with wild abandon!
