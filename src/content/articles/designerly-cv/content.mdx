...
<table cellpadding="16px">
  <tbody>
    <tr>
      <td>
        <img src="/images/articles/designerly-cv/output-screenshot-1.png" width="100px" style={{ margin: '0.125rem' }} />
      </td>
      <td>
        <img src="/images/articles/designerly-cv/output-screenshot-2.png" width="100px" style={{ margin: '0.125rem' }} />
      </td>
      <td>
        <img src="/images/articles/designerly-cv/output-screenshot-3.png" width="100px" style={{ margin: '0.125rem' }} />
      </td>
    </tr>
  </tbody>
</table>