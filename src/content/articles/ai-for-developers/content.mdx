...
- [Explaining code or others' pull requests](#explaining-code-or-others-pull-requests)
- [Code reviews](#code-reviews)
- [Generating alternative solutions](#generating-alternative-solutions)
...
## Explaining code or others' pull requests

If there is any code in a solution I'm unfamiliar with, AI can help speed up my comprehension by explaining it in plain language.

However, I don't trust the AI to explain everything accurately. So I include in the prompt a request to provide sources, such as references to code files and line numbers, to back up its claims.

<a name="content--prompt--explain-code" />
...
<a name="content--prompt--explain-pr" />
...
Producing alternative designs, comparing them, and selecting one is a tactic recommended by software design expert John Ousterhout.
...
Engineer time, of course, tends to be highly constrained.

Why not prompt AI to generate alternative implementations instead, so we can then compare their effectiveness?

<a name="content--prompt--implement-requirements-alternative" />
...
Upon selecting an approach, we can then fix any defects or oversights in the AI generated code. Or generate the solution ourselves from scratch, incorporating parts of the AI generated code as suitable.

I sometimes like to kick off multiple agents generating solutions at once. I keep them running in separate ephemeral terminal windows and separate repository folders using [Git worktree](https://git-scm.com/docs/git-worktree).
