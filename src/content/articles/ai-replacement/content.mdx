...
So here are a few hunches based on my own observations:
...
AI adoption might initially appear to be on an exponential growth curve, but on further investigation, there may be certain limits to that growth.
...
We might be wiser to apply a [logistic function](https://en.wikipedia.org/wiki/Logistic_function), taking into account limits to growth.
