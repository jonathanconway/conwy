> Caveat: As always, I'm open to, and actively seeking, critiques. So please share your disagreements if you will. Here's an <a href="https://brooker.co.za/blog/2025/12/16/natural-language.html" target="_blank">alternative opinion by Marc Brooker</a> that seems well thought through.
...
> Pull-quote: “The unemployment rate has been a little lower than expected and measures of labour underutilisation remain at low rates. Growth in the Wage Price Index has eased from its peak, but broader measures of wages growth continue to be strong and growth in unit labour costs remains high.”
>
...
![Software Developers Percent change in employment, projected 2024–34 from BLS](https://conwy.co/images/articles/ai-replacement/bls-dev-growth.png)
...
- 👉 **Accountability.** Humans can be made responsible and held accountable for achieving business outcomes. The carrot of recognition (promotions, wages, reputation, etc.), and the stick of firing, are used to incentivise employees to perform. AI does not work this way. With AI, you get what you choose and pay for, but with no built-in accountability if things go wrong. Nassim Taleb calls this "skin in the game" and it is integral to how much of the economy functions. The need for someone to hypothetically "point the finger at" is a key reason many (arguably, most) individuals are keeping their jobs, even in cases where AI might replace a lot of what they do.
...
- [Don't Let AI Dull Your Software Engineering Edge • Andy WONG](https://www.awongcm.io/blog/2026/04/25/don-t-let-ai-dull-your-software-engineering-edge/)
- [AI Is Not Improving Productivity • Daron ACEMOGLU](https://www.youtube.com/watch?v=UXK-LJ1VoDs)
- [The Eternal Promise: A History of Attempts to Eliminate Programmers • Ivan TURKOVIC](https://www.ivanturkovic.com/2026/01/22/history-software-simplification-cobol-ai-hype/)

Alternative opinion:

- [On the success of 'natural language programming' • Marc BROOKER](https://brooker.co.za/blog/2025/12/16/natural-language.html)
