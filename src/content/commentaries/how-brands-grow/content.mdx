...
Interesting. Maybe similar idea to "System 2" ([Thinking Fast and Slow](/books/thinking-fast-and-slow)) and "Authority" and "Commitment and Consistency" in [Influence](/commentaries/influence). This demonstrates how important it is to understand the methods by which a finding was reached and not just trust the stated outcome. One can see also how political agendas can impact advertising and branding – perhaps this explains the "woke" politics infiltrating marketing of Gilette and Nike in the early 2020s.
...
Again, principles from [Influence](/commentaries/influence) apply: linking of celebrities to products is another way advertisers cash in on the association principle.
