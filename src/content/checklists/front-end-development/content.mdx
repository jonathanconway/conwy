> Aside: 🚧 Note: This is a work-in-progress. I am continuously improving it and also welcome your [comments and suggestions](/articles/front-end-development-checklist#article-discussion).
...
[^testing]: Testing refers to test specification and implementation, used to verify correctness and quality of the application. Both manual and automated testing is covered here.
...
[^testing-react]: React section covers items related to automated testing on React applications.
...
[^code]: Code refers to instructions written in a programming language.
...
[^pipeline]: Pipeline refers to processes that move code changes through stages like coding, building, testing, and deployment, to achieve Continuous Integration (CI) and Continuous Delivery (CD).
