...
- [ ] Keep all secrets or sensitive data in a secret vault or store.<br />
  For example: API keys, database credentials, etc.<br />
  [Tool: HashiCorp Vault](https://www.vaultproject.io)<br />
  [Tool: AWS Secrets Manager](https://aws.amazon.com/secrets-manager/)<br />
  [Tool: Azure Key Vault](https://azure.microsoft.com/en-us/services/key-vault/)<br />
  [Tool: Google Cloud Secret Manager](https://cloud.google.com/secret-manager)<br />
  #nfr--security
