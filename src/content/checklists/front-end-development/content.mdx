...
- [ ] Write readable, well formatted commits.<br />
  ...
  #general--version-control #general--documentation
...
- [ ] Make sure everything is provided for devs to checkout and test from scratch.<br />
  ...
  #general--pull-request #nfr--testability
...
- [ ] Check parameters and early return / throw if unexpected.<br />
  ...
  #general--code #nfr--reliability #nfr--correctness #language--typescript
- [ ] Avoid code that dynamically accesses other code without the developer being aware, and might break if that code changes.<br />
  #general--code #nfr--reliability #nfr--maintainability
- [ ] Perform impact analysis if adding an entry in some structure.<br />
  ...
  #general--code #nfr--reliability #nfr--correctness
...
#### Usability - Date and time [^date-and-time]
...
- [ ] Use clean code.<br />
  ...
  #general--code #nfr--simplicity #nfr--readability
- [ ] Use library and language facilities correctly. Don't re-invent the wheel.<br />
  #general--code #nfr--readability #nfr--performance #nfr--reliability
...
- [ ] If code is removed, also find and remove now-unused / "orphaned" code.<br />
  #general--code #nfr--readability #nfr--maintainability.<br />
...
#### Patterns - Functional Programming (FP)
