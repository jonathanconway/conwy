...
[^architecture]: Architecture items refer to architecture as it influences, or is influenced by, the front end.
...
[^general-ai]: AI refers to Artificial Intelligence as it relates to front end development, such as coding assistants, code review and other tools, and also AI integrations.
