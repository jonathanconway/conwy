...
- [ ] Communicate intent.<br />
  ...
  #concern--comments
- [ ] Communicate the bigger picture where appropriate.<br />
...
- [ ] Perform exploratory testing.<br />
  ...
  #testing--manual
- [ ] Involve diverse participants, including real users (as appropriate), in testing.<br />
...
- [ ] When mocking API calls, ensure they are aligned with the real Backend.<br />
  If necessary, check API specs, or run automated API client generators, to ensure alignment.<br />
  #testing--mocking
...
- [ ] Ensure changes made to data by a user are reflected across the application and to other users where appropriate.<br />
  #nfr--consistency
...
- [ ] Careful consuming third-party packages or components from untrusted sources.<br />
  Minimise use of third-party packages. Check for vulnerabilities on trusted news sources. Use automated checkers and monitoring tools if possible.<br />
