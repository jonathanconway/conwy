...
Designs and prototypes were produced, ranging from hand sketches and low fidelity wireframes (in Axure RP) to high fidelity (in Photoshop, Sketch) and a full-fledged Single-Page App (SPA). These were rigorously tested with users of a range of cohorts (from members of refugee aid organisations to actual refugees). On each iteration, the findings were documented, analysed/synthesised, and used to inform the design changes for the subsequent iteration.
