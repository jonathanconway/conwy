...
- Core UI framework features, such as the form generator, control suite, OData client. Scalable data-source and grid with virtualisation, dialogs, layouts, scaling and responsive design.
