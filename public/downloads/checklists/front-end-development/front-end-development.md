...
- [ ] Check for subtle logic errors.<br />
      ...
      Confusing inclusive vs. exclusive ranges. _Between_ 1 and 5 vs. _from_ 1 to 5.<br />
...
- [ ] Errors of commission vs. omission.<br />
      ...
      Similarly, when adding new code, be careful that you didn't _forget_ to include something, which might cause an error.<br />
      #general--cleanness
...
- [ ] Only use `waitFor` (avoid `act`) and explicitly wait for a side-effect (some text to appear, callback to be called, etc).<br />
      ...
      #testing--jest
- [ ] Use `waitFor` and `queryBy*` when asserting that an element was _not_ rendered.<br />
      #testing--jest
